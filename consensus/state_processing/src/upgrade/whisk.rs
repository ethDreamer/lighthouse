use std::mem;
use types::{BeaconState, BeaconStateError as Error, BeaconStateWhisk, ChainSpec, EthSpec, Fork};

/// Transform a `Deneb` state into an `Whisk` state.
pub fn upgrade_to_whisk<E: EthSpec>(
    ...
    let post = BeaconState::Whisk(BeaconStateWhisk {
        // Versioning
        ...
        fork: Fork {
            ...
            current_version: spec.whisk_fork_version,
            epoch,
        },
        // History
