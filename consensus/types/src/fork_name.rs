...
impl ForkName {
    ...
    pub fn make_genesis_spec(&self, mut spec: ChainSpec) -> ChainSpec {
        ...
        match self {
            ...
            ForkName::Whisk => {
                ...
                spec.capella_fork_epoch = Some(Epoch::new(0));
                spec.deneb_fork_epoch = Some(Epoch::new(0));
                spec.whisk_fork_epoch = Some(Epoch::new(0));
                spec
            }
        }
    }
    ...
    pub fn previous_fork(self) -> Option<ForkName> {
        match self {
            ...
            ForkName::Whisk => Some(ForkName::Deneb),
        }
    }
    ...
    pub fn next_fork(self) -> Option<ForkName> {
        match self {
            ...
            ForkName::Deneb => Some(ForkName::Whisk),
            ForkName::Whisk => None,
        }
    }
}
