...
pub struct BeaconProcessorQueueLengths {
    ...
    gossip_execution_payload_chunk_queue: usize,
...
impl BeaconProcessorQueueLengths {
    pub fn from_state<E: EthSpec>(
        ...
        Ok(Self {
            ...
            // Up to `MAX_PAYLOAD_CHUNKS` chunks per payload, across a few slots of pending blocks.
            gossip_execution_payload_chunk_queue: 4096,
...
pub struct WorkQueues<E: EthSpec> {
    ...
    pub gossip_execution_payload_chunk_queue: FifoQueue<Work<E>>,
...
impl<E: EthSpec> WorkQueues<E> {
    pub fn new(queue_lengths: BeaconProcessorQueueLengths) -> Self {
        ...
        let gossip_execution_payload_chunk_queue =
            FifoQueue::new(queue_lengths.gossip_execution_payload_chunk_queue);
