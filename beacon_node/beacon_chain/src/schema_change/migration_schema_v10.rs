...
use eth1::{BlockCache, SszDepositCacheV1, SszDepositCacheV10, SszEth1CacheV1, SszEth1CacheV10};
...
pub fn update_eth1_cache(persisted_eth1_v1: SszEth1) -> Result<SszEth1, Error> {
    ...
    let deposit_cache_v10 = SszDepositCacheV10 {
        logs,
        leaves,
        deposit_contract_deploy_block,
    ...
    let ssz_eth1_cache_v10 = SszEth1CacheV10 {
        block_cache,
        deposit_cache: deposit_cache_v10,
        last_processed_block,
    };

    let persisted_eth1_v10 = SszEth1 {
        use_dummy_backend,
        backend_bytes: ssz_eth1_cache_v10.as_ssz_bytes(),
    };

    Ok(persisted_eth1_v10)
}

pub fn downgrade_eth1_cache(persisted_eth1_v10: SszEth1) -> Result<Option<SszEth1>, Error> {
    if persisted_eth1_v10.use_dummy_backend {
        // backend_bytes is empty when using dummy backend
        return Ok(Some(persisted_eth1_v10));
    }
    ...
    let ssz_eth1_cache_v10 = SszEth1CacheV10::from_ssz_bytes(&backend_bytes)?;
    let SszEth1CacheV10 {
        block_cache,
        deposit_cache: deposit_cache_v10,
        last_processed_block,
...
pub fn reinitialized_eth1_cache_v10(deposit_contract_deploy_block: u64) -> SszEth1 {
