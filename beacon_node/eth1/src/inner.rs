...
use crate::{
    ...
    deposit_cache::{DepositCache, SszDepositCache, SszDepositCacheV1, SszDepositCacheV10},
...
pub type SszEth1Cache = SszEth1CacheV10;
...
pub struct SszEth1Cache {
    ...
    pub deposit_cache: SszDepositCacheV10,
